...
const DashboardLayout = () => {
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            <AppBar sx={{ backgroundColor: "#28DC2F" }} position="absolute">
                <Toolbar
                    sx={{
                        pr: '24px',
                    }}
                >
                    ...
                    <Typography
                        ...
                        Plataforma de Cursos para desarrollador Web
                    </Typography>
                    <PopMenu />
                </Toolbar>
            </AppBar>
            ...
            >
                <Toolbar />
                <Container backgroundColor="33FF3C" maxWidth="lg" sx={{ mt: 20, mb: 4 }}>
                    <Outlet />
                </Container>
            </Box>
        </Box>
